...
export default function Privacy() {
  return (
    <Layout>
      ...
      <p>
        Your privacy is important to us. It is AndrewBraun.dev's policy to
        respect your privacy regarding any information we may collect from you
        across our website,{" "}
        <a href="http://andrewbraun.dev">http://andrewbraun.dev</a>, and other
      ...
      <p>This policy is effective as of 21 August 2020.</p>
      <p>
